...
const components = {
  ...
  Link: ({ className, ...props }: React.ComponentProps<typeof Link>) => (
    <Link
      className={cn(
        "font-medium text-gray-700 dark:text-gray-300 no-underline transition-all duration-300 ease-in-out hover:underline hover:text-gray-900 dark:hover:text-gray-100",
        className
      )}
      {...props}
    />
